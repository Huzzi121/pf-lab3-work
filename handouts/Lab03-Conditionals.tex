...
\mintinline{c}{char} variables since they are essentially integers).  
Moreover, the control flow can easily lead to unexpected results if 
you forget to include the \mintinline{c}{break} statement at the end 
of each case.  
...
Answer the questions on your worksheet (see \mintinline{text}{worksheet.md}).
...
\begin{enumerate}
  ...
  \begin{itemize}
    \item \mintinline{text}{taxes.c}
    \item \mintinline{text}{calculator.c}
    \item \mintinline{text}{leapYear.c}
